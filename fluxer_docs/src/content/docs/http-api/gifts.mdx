...
<sup>1</sup> Exactly 32 case-sensitive letters and digits
...
<sup>3</sup> Neither the redemption time nor the redeeming account appears in this object
...
Entitlement changes send [User Update](/gateway/events/#user-update) to the redeemer's sessions.
