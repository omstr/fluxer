...
const CONTENT_I18N_ZH_CN_MESSAGES = defineContentI18nLocaleMessages({
	"auth.unknown_location": "未知位置",
	"billing.donation_description_monthly": "按月捐赠以支持 {product_name}",
	"billing.donation_description_one_time": "一次性捐赠以支持 {product_name}",
	"billing.donation_description_yearly": "按年捐赠以支持 {product_name}",
	"billing.donation_name_one_time": "{product_name} 捐赠",
	"billing.donation_name_recurring": "{product_name} 定期捐赠",
