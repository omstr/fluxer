...
const EMAIL_I18N_KO_MESSAGES = defineEmailI18nLocaleMessages({
	...
	"email_change_revert": {
		"subject": "{product_name} 이메일이 변경되었어요",
	...
	"harvest_completed": {
		"subject": "{product_name} 데이터 내보내기를 다운로드할 수 있어요",
		"body": "안녕하세요, {username}님.\n\n데이터 내보내기가 준비되었어요.\n\n다운로드 링크:\n{downloadUrl}\n\n포함된 메시지: {totalMessages, number}개\n파일 크기: {fileSizeMB, number} MB\n\n이 링크는 {expiresAt, date, full} {expiresAt, time, short}에 만료돼요.\n\n이 내보내기를 요청하지 않으셨다면 즉시 비밀번호를 변경하고 고객지원팀에 문의해 주세요.\n\n– {product_name} 팀"
	},
	"inactivity_warning": {
		"subject": "장기간 미접속으로 {product_name} 계정이 삭제될 예정이에요",
		"body": "안녕하세요, {username}님.\n\n{lastActiveDate, date, full} 이후로 {product_name} 계정에서 활동이 없었어요.\n\n{deletionDate, date, full} {deletionDate, time, short}까지 로그인하지 않으면 장기간 미접속으로 계정이 영구적으로 삭제될 예정이에요.\n\n여기에서 로그인해 주세요:\n{loginUrl}\n\n최근에 {product_name}를 사용하셨다면 즉시 고객지원팀에 문의해 주세요.\n\n– {product_name} 팀"
	},
	"ip_authorization": {
		"subject": "새 IP 주소 로그인 승인",
		"body": "안녕하세요, {username}님.\n\n새로운 IP 주소에서 {product_name} 계정으로 로그인 시도가 감지되었어요:\n\nIP 주소: {ipAddress}\n위치: {location}\n\n본인이 시도한 경우, 아래 링크를 클릭하여 이 IP 주소를 승인해 주세요:\n\n{authUrl}\n\n로그인을 시도하지 않으셨다면 즉시 비밀번호를 변경해 주세요.\n\n이 링크는 30분 동안 유효해요.\n\n– {product_name} 팀"
	},
	"mfa_backup_codes_view": {
		"subject": "{product_name} 백업 코드 액세스 확인",
