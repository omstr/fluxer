...
const EMAIL_I18N_RO_MESSAGES = defineEmailI18nLocaleMessages({
	...
	"dsa_report_verification": {
		...
		"body": "Salut,\n\nFolosește codul de verificare de mai jos pentru a trimite raportul tău conform Digital Services Act pe {product_name}:\n\n{code}\n\nAcest cod expiră la data de {expiresAt, date, full} la ora {expiresAt, time, short}.\n\nDacă nu ai solicitat acest lucru, poți ignora acest e-mail.\n\n– Echipa de siguranță {product_name}"
	},
	"email_change_new": {
		"subject": "Verifică-ți noul e-mail pentru {product_name}",
		"body": "Salut {username},\n\nIntrodu acest cod în aplicație pentru a-ți verifica noua adresă de e-mail {product_name}:\n\n{code}\n\nAcest cod expiră la data de {expiresAt, date, full} la ora {expiresAt, time, short}.\n\nDacă nu ai solicitat acest lucru, poți ignora acest e-mail.\n\n– Echipa {product_name}"
	},
	...
	"email_change_revert": {
		...
		"body": "Salut {username},\n\nAdresa de e-mail a contului tău {product_name} a fost schimbată în {newEmail}.\n\nDacă tu ai făcut această modificare, nu trebuie să faci nimic. Dacă nu ai făcut-o tu, poți anula modificarea și îți poți securiza contul folosind acest link:\n\n{revertUrl}\n\nAceasta va restabili adresa ta de e-mail anterioară, te va deconecta de pe toate dispozitivele, va elimina numerele de telefon asociate, va dezactiva MFA și îți va cere să setezi o parolă nouă.\n\n– Echipa de siguranță {product_name}"
	},
	"email_verification": {
