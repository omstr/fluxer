...
const EMAIL_I18N_HE_MESSAGES = defineEmailI18nLocaleMessages({
	...
	"email_change_new": {
		"subject": "אימות האימייל החדש שלכם ב-{product_name}",
		"body": "שלום {username},\n\nהזינו קוד זה באפליקציה כדי לאמת את האימייל החדש שלכם ב-{product_name}:\n\n{code}\n\nקוד זה יפוג בתאריך {expiresAt, date, full} בשעה {expiresAt, time, short}.\n\nאם לא ביקשתם זאת, אתם יכולים להתעלם מאימייל זה.\n\nצוות {product_name}"
	},
	"email_change_original": {
		"subject": "אישור שינוי האימייל שלכם ב-{product_name}",
	...
	"email_verification": {
		...
		"body": "שלום {username},\n\nאנא אמתו את כתובת האימייל של חשבון ה-{product_name} שלכם באמצעות לחיצה על הקישור למטה:\n\n{verifyUrl}\n\nאם לא יצרתם חשבון {product_name}, אתם יכולים להתעלם בבטחה מאימייל זה.\n\nקישור זה תקף למשך 24 שעות.\n\nצוות {product_name}"
	},
